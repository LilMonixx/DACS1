...
public class Enemy7 {
    ...
    private final float speed = 30f; // tốc độ di chuyển ngang
    ...
    private final float minX = 225f;
    private final float maxX = 320f;

    public Enemy7() {
        this.atlas = new TextureAtlas(Gdx.files.internal("Enemy7/E7.atlas"));
        this.position = new Vector2(225, 690); // vị trí bắt đầu

        Array<TextureRegion> frames = new Array<>();
        frames.add(atlas.findRegion("E7.5"));
        frames.add(atlas.findRegion("E7.6"));
        frames.add(atlas.findRegion("E7.2"));
        frames.add(atlas.findRegion("E7.1"));
        frames.add(atlas.findRegion("E7.4"));
        frames.add(atlas.findRegion("E7.3"));
        frames.add(atlas.findRegion("E7.7"));
        frames.add(atlas.findRegion("E7.8"));
