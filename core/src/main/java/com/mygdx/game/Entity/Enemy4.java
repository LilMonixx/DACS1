...
public class Enemy4 {
    ...
    public Enemy4() {
        this.atlas = new TextureAtlas(Gdx.files.internal("Enemy4/E4.atlas"));
        this.position = new Vector2(650, 200);

        Array<TextureRegion> frames = new Array<>();
        frames.add(atlas.findRegion("E4.1"));
        frames.add(atlas.findRegion("E4.2"));
        frames.add(atlas.findRegion("E4.5"));
        frames.add(atlas.findRegion("E4.6"));
        frames.add(atlas.findRegion("E4.7"));
        frames.add(atlas.findRegion("E4.8"));
        frames.add(atlas.findRegion("E4.3"));
        frames.add(atlas.findRegion("E4.4"));
